        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('layout/title/ftopic/title_home'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-4">
                            <?php $this->load->view('ftopic/home/top/top_view'); ?>
                            <?php $this->load->view('ftopic/home/pos_com/pos_com_view'); ?>
                            <?php $this->load->view('ftopic/home/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-4">
                            <?php $this->load->view('ftopic/home/account/account'); ?>
                            <?php $this->load->view('ftopic/home/composition/composition_view'); ?>
                            <?php $this->load->view('ftopic/home/count_likes/count_likes_view'); ?>
                        </section>
                        <!-- right col -->

                        
                        <section class="col-md-4">
                           <?php $this->load->view('ftopic/home/streaming/streaming'); ?>
                        </section>
