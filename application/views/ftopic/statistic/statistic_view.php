        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    <!-- /.search form -->
                    <?php $this->load->view('layout/widget/sidebar_ftopic'); ?>
                    <!-- ./sidebar -->
                </section>
                <!-- /.sidebar -->
            </aside>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/ftopic/title_statistic'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <?php $this->load->view('ftopic/profile/profile_view'); ?>

                        <!-- Right Col -->
                        <section class="col-md-4">
                            <?php $this->load->view('ftopic/statistic/account/account'); ?>
                            <?php $this->load->view('ftopic/statistic/count_likes/count_likes_view'); ?>
                            <?php $this->load->view('ftopic/statistic/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-5">
                            <?php $this->load->view('ftopic/statistic/commented/commented_view'); ?>
                            <?php $this->load->view('ftopic/statistic/pos_com/pos_com_view'); ?>
                            <?php $this->load->view('ftopic/statistic/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->
