        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/ftopic/title_dashboard'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-9">
                            <?php $this->load->view('ftopic/dashboard/post/post_view'); ?>
                        </section>
                        
                        
                        <section class="col-md-9">
                            <?php $this->load->view('ftopic/dashboard/fans/fans_view'); ?>
