        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('layout/title/itopic/title_home'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-4">
                            <?php $this->load->view('itopic/home/top/top_view'); ?>
                            <?php $this->load->view('itopic/home/pos_com/pos_com_view'); ?>
                            <?php $this->load->view('itopic/home/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-4">
                            <?php $this->load->view('itopic/home/hashtag_view'); ?>
                            <?php // $this->load->view('itopic/home/account/account'); ?>
                            <?php $this->load->view('itopic/home/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->

                        
                        <section class="col-md-4">
                           <?php $this->load->view('itopic/home/streaming/streaming'); ?>
                        </section>
