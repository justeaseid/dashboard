        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/twitter/title_analyze'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-9">
                            <?php $this->load->view('twitter/analyze/sentiment/sentiment_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-3">
                            <?php $this->load->view('twitter/analyze/timesent/pos_frame'); ?>
                        </section>
                        <section class="col-md-3">
                            <?php $this->load->view('twitter/analyze/timesent/neu_frame'); ?>
                        </section>
                        <section class="col-md-3">
                            <?php $this->load->view('twitter/analyze/timesent/neg_frame'); ?>
                        </section>
                        <!-- right col -->
