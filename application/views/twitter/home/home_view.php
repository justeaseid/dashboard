        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('layout/title/twitter/title_home'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-4">
                            <?php $this->load->view('twitter/home/top/top_view'); ?>
                            <?php $this->load->view('twitter/home/account/raccount'); ?>
                            <?php $this->load->view('twitter/home/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-4">
                            <?php $this->load->view('twitter/home/top/rtop_view'); ?>
                            <?php $this->load->view('twitter/home/account/account'); ?>
                            <?php $this->load->view('twitter/home/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->

                        
                        <section class="col-md-4">
                           <?php $this->load->view('twitter/home/streaming/streaming'); ?>
                        </section>
