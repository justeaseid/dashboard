...
//                        echo '<td><button id="delete' . $i . '" type="" class="btn btn-fourth" onclick="delete_facebook(' . $row['tk_id'] . ');">Delete</button></td>';
                        echo "</tr>";
                        $i++;
                    }
                }
...
<script>
    ...
    function delete_facebook(facebook_id) {
        top.location = "<?php echo base_url('/facebook/token_delete/' . $url . '/1') ?>/" + facebook_id;
    }
</script>
