<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('/facebook/insert_token/'.$url.'/1') ?>" method="post">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <a class="btn btn-primary" href="<?php echo base_url('/facebook/token/'.$url.'/1');?>">Back</a>
