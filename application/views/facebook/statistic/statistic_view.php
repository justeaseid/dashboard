...
<html>
    <head>
        ...
        <title>Asosiantale | Statistic</title>

        <!-- linked icon ezytravel -->
        ...
        <!-- JCloud JS and CSS -->
        <link rel="stylesheet" type="text/css" href="<?php echo GENERAL_JS; ?>/jqcloud/jqcloud.css" />
        <script type="text/javascript" src="<?php echo GENERAL_JS; ?>/jquery/jquery.js"></script>
        <script type="text/javascript" src="<?php echo GENERAL_JS; ?>/jquery/jquery-1.4.4.min.js"></script>
        <script type="text/javascript" src="<?php echo GENERAL_JS; ?>/jqcloud/jqcloud-1.0.4.js"></script>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/facebook/title_statistic'); ?>
                </section>
                <!-- Main content with additional feature/function -->
                <section class="content">             
                    <!-- Main row -->
                    <div class="row">
                        <!-- view page profile detail -->
                        <?php $this->load->view('facebook/profile/profile_view'); ?>

                        <!-- Right Col -->
                        <section class="col-md-4">
                            <?php $this->load->view('facebook/statistic/account/account'); ?>
                            <?php $this->load->view('facebook/statistic/count_likes/count_likes_view'); ?>
                            <?php $this->load->view('facebook/statistic/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-5">
                            <?php $this->load->view('facebook/statistic/commented/commented_view'); ?>
                            <?php $this->load->view('facebook/statistic/pos_com/pos_com_view'); ?>
                            <?php $this->load->view('facebook/statistic/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->

                        <!-- dashboard view ended here -->
