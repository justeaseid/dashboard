<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('/facebook/insert_crawler/' . $url . '/1') ?>" method="post">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="page">
                        ...
                        if ($json_page->num_rows() > 0) {
                            ...
                            foreach ($json_page->result_array() as $row) {
                                if($j==0)
                                    echo '<option value="'.$row['pg_id'].'" selected="selected">'.$row['pg_name'].'</option>';
                                else
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <a class="btn btn-primary" href="<?php echo base_url('/facebook/crawler/'.$url.'/1');?>">Back</a>
