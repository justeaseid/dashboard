        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/ttopic/title_trend'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-4">
                            <?php $this->load->view('ttopic/trend/hashtags/tweet_view'); ?>
                            <?php $this->load->view('ttopic/trend/hashtags/mention_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-5">
                            <?php $this->load->view('ttopic/trend/hashtags/general_view'); ?>
                        </section>
                        <!-- right col -->
