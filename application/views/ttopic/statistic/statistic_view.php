        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    <!-- /.search form -->
                    <?php $this->load->view('layout/widget/sidebar_ttopic'); ?>
                    <!-- ./sidebar -->
                </section>
                <!-- /.sidebar -->
            </aside>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/ttopic/title_statistic'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <?php $this->load->view('ttopic/profile/profile_view'); ?>

                        <!-- Right Col -->
                        <section class="col-md-4">
                            <?php $this->load->view('ttopic/statistic/account/raccount'); ?>
                            <?php $this->load->view('ttopic/statistic/share_likes/share_likes_view'); ?>
                            <?php $this->load->view('ttopic/statistic/count_likes/count_likes_view');?>
                        </section>
                        
                        <!-- Bottom Column -->
                        <section class="col-md-5">
                            <?php $this->load->view('ttopic/statistic/commented/rcommented_view'); ?>
                            <?php $this->load->view('ttopic/statistic/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->
