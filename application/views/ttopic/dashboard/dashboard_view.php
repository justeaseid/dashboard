        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/ttopic/title_dashboard'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-9">
                            <?php $this->load->view('ttopic/dashboard/post/post_view'); ?>
                        </section>
                        
                        <section class="col-md-9">
                            <?php $this->load->view('ttopic/dashboard/fans/fans_view'); ?>
