        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('layout/title/ttopic/title_home'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-4">
                            <?php $this->load->view('ttopic/home/top/top_view'); ?>
                            <?php $this->load->view('ttopic/home/account/raccount'); ?>
                            <?php $this->load->view('ttopic/home/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-4">
                            <?php $this->load->view('ttopic/home/top/rtop_view'); ?>
                            <?php $this->load->view('ttopic/home/account/account'); ?>
                            <?php $this->load->view('ttopic/home/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->

                        
                        <section class="col-md-4">
                           <?php $this->load->view('ttopic/home/streaming/streaming'); ?>
                        </section>
