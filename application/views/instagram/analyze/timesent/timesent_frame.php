<div class="box box-warning direct-chat direct-chat-success" >
    <div class="box-header with-border">
        <h3 class="box-title">Sentiment Streaming</h3>
...
<!--            <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
    ...
    <div class="box-body">
        ...
        <div class="direct-chat-messages" style="height: 400px;">
            <?php
            if ($timesent->num_rows() > 0) {
                $i = 0;
                foreach ($timesent->result_array() as $row) {
                    ...
                    echo "<span class='direct-chat-timestamp pull-right'>" . date("d F Y h:i:s A", strtotime($row["cm_created_time"])) . "</span>";
                    echo "</div>";
