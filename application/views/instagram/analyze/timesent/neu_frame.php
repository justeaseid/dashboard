<div class="box box-warning direct-chat direct-chat-success" >
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <span class="label label-warning">Now</span>
<!--            <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
    ...
    <div class="box-body">
        ...
        <div class="direct-chat-messages" style="height: 400px;">
            <?php
            if ($neutral->num_rows() > 0) {
                $i = 0;
                foreach ($neutral->result_array() as $row) {
                    echo "<a href='#' target=''>";
                    ...
                    . "<select class='form-control select2' style='width: 110px;' name='neu" . $i . "' id='neu" . $i . "' onchange='change_neutral(" . $i . ",\"" . $row['cm_id'] . "\");'>
                            <option value='0' selected='selected'> " . $sentiment . " </option>
...
<script>
    ...
    function change_neutral(idx, cm_id) {
        var sentiment = document.getElementById('neu' + String(idx)).value;
