        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('layout/title/instagram/title_home'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-4">
                            <?php $this->load->view('instagram/home/top/top_view'); ?>
                            <?php $this->load->view('instagram/home/pos_com/pos_com_view'); ?>
                            <?php $this->load->view('instagram/home/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-4">
                            <?php $this->load->view('instagram/home/hashtag_view'); ?>
                            <?php // $this->load->view('instagram/home/account/account'); ?>
                            <?php $this->load->view('instagram/home/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->

                        
                        <section class="col-md-4">
                           <?php $this->load->view('instagram/home/streaming/streaming'); ?>
                        </section>
