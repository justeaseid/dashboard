<div class="col-md-3">
    ...
    <div class="box box-primary">
        <div class="box-body box-profile">
            ...
            <!--<img class="profile-user-img img-responsive img-circle" src="https://graph.instagram.com/v2.5/5863091683/picture?type=normal&fields=url&access_token=439288276256553%7C1N79oU5HUNV7g2fraZ4emqgGpx8" alt="<?php echo $pg_name;?>">-->
            ...
            <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                    <b>Followers</b> <a class="pull-right"><?php echo $pg_likes;?></a>
                </li>
                <li class="list-group-item">
                    <b>Friends</b> <a class="pull-right"><?php echo $pg_talking_about_count;?></a>
                </li>
                <li class="list-group-item">
                    <b>Post</b> <a class="pull-right"><?php echo $pg_checkins;?></a>
                </li>
            </ul>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <p class="text-muted">
                <a href="<?php echo $pg_website;?>" target="_blank"><?php echo $pg_name;?></a>
            </p>
