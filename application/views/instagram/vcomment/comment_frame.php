<div class="box box-primary direct-chat direct-chat-primary" >
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            <a class="btn btn-warning" href="<?php echo base_url('/instagram/post/' . $url . '/1'); ?>">Back to List</a>
        </div>
    </div><!-- /.box-header -->
    <div class="box-body">
        ...
        <div class="direct-chat-messages" style="height: 450px;">
            ...
            if ($posting->num_rows() > 0) {
                ...
                foreach ($posting->result_array() as $row) {
                    echo "<a href='" . INS_PAGE . $row["ps_id"] . "' target='_blank'>";
                    ...
                    . "<div class='fa fa-heart margin-r-5'>  " . $row["ps_likes"] . "</div>   "
                    . "<div class='fa fa-comments margin-r-5'>  " . $row["ps_comments"] . "</div>   "
                    . "</div>";
                    echo "</div>";
                    echo "</a>";
                }
