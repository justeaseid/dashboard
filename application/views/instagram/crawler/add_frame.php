<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url('/instagram/insert_crawler/' . $url . '/1') ?>" method="post">
            ...
            <div class="form-group">
                <label for="inputPage" class="col-sm-2 control-label">Page Name</label>
                <div class="col-sm-10">
                    <select class="form-control select2" style="width: 100%;" name="page">
                        ...
                        if ($json_page->num_rows() > 0) {
                            ...
                            foreach ($json_page->result_array() as $row) {
                                if($j==0)
                                    echo '<option value="'.$row['pg_id'].'" selected="selected">'.$row['pg_username'].'</option>';
                                else
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <a class="btn btn-primary" href="<?php echo base_url('/instagram/crawler/'.$url.'/1');?>">Back</a>
