...
//                        echo "<td>" . $row['last_update'] . "</td>";
                        ...
                        echo '<td><button id="delete' . $i . '" type="" class="btn btn-fourth" onclick="delete_instagram(' . $row['cw_id'] . ');">Delete</button></td>';
                        echo "</tr>";
                        $i++;
                    }
                }
...
<script>
    ...
    function delete_instagram(instagram_id) {
        top.location = "<?php echo base_url('/instagram/crawler_delete/' . $url . '/1') ?>/" + instagram_id;
    }
</script>