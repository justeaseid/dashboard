        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/instagram/title_statistic'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <?php $this->load->view('instagram/profile/profile_view'); ?>

                        <!-- Right Col -->
                        <section class="col-md-4">
                            <?php $this->load->view('instagram/statistic/tweet_view'); ?>
                            <?php // $this->load->view('instagram/statistic/account/account'); ?>
                            <?php $this->load->view('instagram/statistic/share_likes/share_likes_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-5">
                            <?php // $this->load->view('instagram/statistic/commented/commented_view'); ?>
                            <?php $this->load->view('instagram/statistic/pos_com/pos_com_view'); ?>
                            <?php $this->load->view('instagram/statistic/composition/composition_view'); ?>
                        </section>
                        <!-- right col -->
