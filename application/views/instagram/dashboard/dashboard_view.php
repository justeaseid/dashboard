        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <?php $this->load->view('layout/title/instagram/title_dashboard'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-5">
                            <?php $this->load->view('instagram/dashboard/post/post_view'); ?>
                        </section>
                        
                        <section class="col-md-4">
                            <?php $this->load->view('instagram/dashboard/graph/streaming'); ?>
                            
                        </section>
                        
                        <section class="col-md-9">
                            <?php $this->load->view('instagram/dashboard/fans/fans_view'); ?>
