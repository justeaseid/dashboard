<div style="width: 100%;height: 30px;">
    <div style="float: left;display: inline-table;">
        <a class="btn btn-warning" href="<?php echo base_url('/instagram/monitoring/' . $url . '/' . $id_user); ?>">Back</a>
    </div>
...
<script>
    ...
    function change_timeline() {
        ...
        top.location = "<?php echo base_url('/instagram/statistic/' . $url . '/1') ?>/" + page_id+"/"+type;
    }
</script>