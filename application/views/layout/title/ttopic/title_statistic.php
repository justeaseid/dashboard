<div style="width: 100%;height: 30px;">
    <div style="float: left;display: inline-table;">
        <a class="btn btn-warning" href="<?php echo base_url('/ttopic/monitoring/' . $url . '/' . $id_user . '/'. $topic_id); ?>">Back to <b><?php echo strtoupper($topic_name);?></b></a>
    </div>
...
<script>
    ...
    function change_timeline() {
        ...
        top.location = "<?php echo base_url('/ttopic/statistic/' . $url . '/1') ?>/" + page_id + "/<?php echo $topic_id;?>/" + type;
    }
</script>