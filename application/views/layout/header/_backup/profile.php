...
//            echo $access;
            ...
            <!--            <li class="dropdown user user-menu notifications-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo APPS_ICON; ?>" class="user-image" alt="Apps Image">
                                <span class="hidden-xs">Application</span>
                            </a>
                            <ul class="dropdown-menu" style="width: 200px; height: 150px;">
                            <ul class="dropdown-menu" style="width: 200px; height: 80px;">
                                <li> 
                                    <ul class="menu">
                                        <li>
                                            <a class = "fa fa-database" href="<?php echo base_url("/apps/monitor/" . $url. '/' . $id_user); ?>">
                                                &nbsp;&nbsp;Data Management
                                            </a>
                                        </li>
                                        <li>
                                            <a class = "fa fa-bar-chart" href="<?php echo base_url("/apps/home/" . $url. '/' . $id_user); ?>">
                                                &nbsp;&nbsp;Monitoring & Analysis
                                            </a>
                                        </li>
                                    </ul>
