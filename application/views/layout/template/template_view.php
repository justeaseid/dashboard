...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<?php echo DIST_IMG; ?>/analytic1.png" />
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <?php $this->load->view('header/profile'); ?>
            </header>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    <!-- Sidebar user panel -->
                    <?php $this->load->view('widget/profile'); ?>
                    <!-- search form -->
                    <?php $this->load->view('widget/search'); ?>
                    <!-- /.search form -->
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('panel/title'); ?>
                </section>
                ...
                <section class="content">
                    ...
                    <div class="row">
                        <?php $this->load->view('panel/order'); ?>
                        <!-- ./col -->
                        <?php $this->load->view('panel/rate'); ?>
                        <!-- ./col -->
                        <?php $this->load->view('panel/user'); ?>
                        <!-- ./col -->
                        <?php $this->load->view('panel/visitor'); ?>
                        <!-- ./col -->
                    </div>
                    <!-- /.row -->
                    <!-- Main row -->
                    <div class="row">
                        ...
                        <section class="col-lg-7 connectedSortable">
                            ...
                            <?php $this->load->view('chart/tab_chart'); ?>
                            <!-- /.nav-tabs-custom -->

                            <!-- BAR CHART -->
                            <?php $this->load->view('chart/bar_chart'); ?>
                            <!-- ./BAR CHART --!>

                            </section><!-- /.Left col -->
                            <section class="col-lg-5 connectedSortable">
                                <!-- Map box -->
                                <?php $this->load->view('map/map_box'); ?>
                                <!-- /.box -->

                                <!-- solid sales graph -->
                                <?php $this->load->view('chart/sales'); ?>
                                <!-- /.solid sales graph --!>
