        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <?php $this->load->view('layout/title/title'); ?>
                </section>
                ...
                <section class="content">             
                    ...
                    <div class="row">
                        ...
                        <section class="col-md-4">
                            <?php $this->load->view('content/home/instagram/top_view'); ?>
                            <?php $this->load->view('content/home/twitter/top_view'); ?>
                            <?php $this->load->view('content/home/facebook/top_view'); ?>
                        </section>

                        <!-- Bottom Column -->
                        <section class="col-md-4">
                            <?php $this->load->view('content/home/instagram/hashtag_view'); ?>
                            <?php $this->load->view('content/home/twitter/hashtag_view'); ?>
                            <?php $this->load->view('content/home/facebook/account'); ?>
                        </section>
                        <!-- right col -->

                        <section class="col-md-4">
                            <?php $this->load->view('content/home/streaming/streaming'); ?>
                        </section>
