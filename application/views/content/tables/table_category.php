    ...
    <div class="box-body">
        ...
        <div style="display: inline-block;width: 100%;">
            ...
            <div style="float: right;">
                <a class="btn btn-primary" href="<?php echo base_url('/category/add/' . $url . '/' . $id_user);?>">Tambahkan</a>
            </div>
        </div>
...
<script>
    function delete_data(data_id) {
        top.location = "<?php echo base_url('/category/delete/' . $url . '/' . $id_user) ?>/" + data_id;
    }

    function edit_data(data_id) {
        top.location = "<?php echo base_url('/category/edit/' . $url . '/' . $id_user) ?>/" + data_id;
    }
</script>
