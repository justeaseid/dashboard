<div class="col-md-12">
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <?php echo $status; ?>
            <form class="form-horizontal" action="<?php echo base_url('/log/edit_log/' . $url . '/1') ?>" method="post">
                <input type="hidden" name="data_id" value="<?php echo $log_id; ?>" />
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" style="width: 100%;" name="type" id="inputType">
                            ...
                            if ($type == "") {
                                ...
                                echo '<option value="' . $type . '" selected="selected">' . ucwords($type) . '</option>';
                            }
                            ?>
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" style="width: 100%;" name="action" id="inputAction">
                            ...
                            if ($type == "") {
                                ...
                                echo '<option value="' . $action . '" selected="selected">' . ucwords($action) . '</option>';
                            }
                            ?>
