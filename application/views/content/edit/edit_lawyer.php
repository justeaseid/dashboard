<div class="col-md-12">
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <?php echo $status; ?>
            <form class="form-horizontal" action="<?php echo base_url('/lawyer/edit_lawyer/'.$url.'/1') ?>" method="post">
                <input type="hidden" name="data_id" value="<?php echo $lawyer_id;?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputID" name="id_card" value="<?php echo $id_card;?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputName" class="col-sm-2 control-label">Organization</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputOrg" name="organization" value="<?php echo $organization;?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputBio" class="col-sm-2 control-label">Specialization</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="3" id="inputSpecialization" name="specialization"><?php echo $specialization;?></textarea>
                    </div>
                </div>
                <div class="form-group">
