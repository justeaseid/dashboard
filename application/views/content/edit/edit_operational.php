<div class="col-md-12">
    <div class="nav-tabs-custom">
        ...
        <div class="tab-content">
            <?php echo $status; ?>
            <form class="form-horizontal" action="<?php echo base_url('/operational/edit_operational/'.$url.'/1') ?>" method="post">
                <input type="hidden" name="data_id" value="<?php echo $operational_id;?>" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPercen" name="percentage" value="<?php echo $percentage;?>">
                    </div>
                </div>
                <div class="form-group">
