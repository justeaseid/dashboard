...
$db['arango']['hostname'] = $host;
$db['arango']['username'] = $username;
$db['arango']['password'] = $password;
...
$db['facebook']['hostname'] = $host;
$db['facebook']['username'] = $username;
$db['facebook']['password'] = $password;
...
$db['twitter']['hostname'] = $host;
$db['twitter']['username'] = $username;
$db['twitter']['password'] = $password;
...
$db['instagram']['hostname'] = $host;
$db['instagram']['username'] = $username;
$db['instagram']['password'] = $password;
