...
$db['facebook']['hostname'] = 'localhost';
$db['facebook']['username'] = 'root';
$db['facebook']['password'] = '';
...
$db['twitter']['hostname'] = 'localhost';
$db['twitter']['username'] = 'root';
$db['twitter']['password'] = '';
...
$db['instagram']['hostname'] = 'localhost';
$db['instagram']['username'] = 'root';
$db['instagram']['password'] = '';
