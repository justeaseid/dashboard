 ...
 * 
 * information:
 * mformatter is formatter data for Instagram monitoring
 * get data from Instagram message and then view that into graph
 * 
            ...
            foreach ($data->result_array() as $row) {
                ...
                if ((($sum_shares == NULL) || ($sum_shares == "NULL")) && (($sum_likes == NULL) || ($sum_likes == "NULL"))) {
                    ...
                    if (($sum_shares == 0) && ($sum_likes == 0)) {
                        ...
                        $output .= '{name:"comments",y:' . $sum_shares . ', color: "#3e4348"},';
